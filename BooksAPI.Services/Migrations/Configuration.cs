namespace BooksAPI.Services.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BooksAPI.Services.Models.BooksAPIServicesContext>
    {
        ...
        protected override void Seed(BooksAPI.Services.Models.BooksAPIServicesContext context)
        {
